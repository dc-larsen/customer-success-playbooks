...
1. **Node Discovery** - Search and get node information
2. **Configuration Validation** - Validate node and workflow configs
3. **Workflow Management** - Create, update, deploy workflows
